...
@section('title_page', "Public contact")
@section('content')
    ...
    @endif
    <form id="multiple_select" class="card" action="{{route('addContact')}}" method="post">
        @csrf
        <div class="card-body">
            <button type="button" class="btn btn-success" data-active="1" onclick="showElem(event)">Use multiple select</button>
            <button id="form-add" type="submit" class="btn btn-success ">Add contacts</button>
        </div>
    </form>
